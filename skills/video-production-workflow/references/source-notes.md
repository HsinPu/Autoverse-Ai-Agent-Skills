...
| `HITsz-TMG/VideoClaw` (formerly `AIGC-Claw`; earlier `FilmAgent`) | `1324b36020570c279cd9560794a8f5508bf7bb70` | MIT | Shot-language selection and review plus environment-asset generation, hard-failure checks, scored evaluation, revision, and best-version selection, expanded into tool-neutral cinematography and production-design ownership |
| `NousResearch/hermes-agent` | `226e8de827a669e8ffa7035b27d70c19e44b1208` | MIT | Supplemental cinematographer responsibility, renderer review, optional post-production roles, music analysis and routing, beat dependencies, master variants, capability routing, and task-graph concepts, expanded into separate CraftRoster ownership contracts |
...
- Keep `source: HsinPu/CraftRoster` on every first-party component.
