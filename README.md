...
目前共收錄 **72** 個 skills：**48** 個 Development、**16** 個 Productivity、**1** 個 Browser Automation、**1** 個 Search & Research、**2** 個 Coding Agents & IDEs、**1** 個 Communication、**3** 個 CLI Utilities。
...
| **[skill-gap-analyzer](skill-gap-analyzer/)** | 比對本地 skills 與 LobeHub 市集，判斷要升級、補新 skill，或維持不變 |
