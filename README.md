...
| 5 | 程式實作 | 幾乎都需要 | `python-development`, `python-data-engineering`, `python-web-scraping`, `python-automation-scripting`, `python-backend-development`, `python-testing-engineering`, `python-observability-debugging`, `python-packaging-release`, `python-concurrency-patterns`, `python-security-hardening`, `python-api-client-development`, `java-development`, `javascript-development`, `typescript-development`, `spring-development`, `vue-development`, `nuxt-development`, `css-development`, `tailwind-development`, `frontend-design`, `react-ui-patterns`, `mybatis-development`, `jquery-development`, `mcp-creator-design` |
...
目前共收錄 **84** 個 skills：**60** 個 Development、**16** 個 Productivity、**1** 個 Browser Automation、**1** 個 Search & Research、**2** 個 Coding Agents & IDEs、**1** 個 Communication、**3** 個 CLI Utilities。
...
| **[accessibility](accessibility/)** | 前端可及性 / WCAG / ARIA / keyboard navigation |
...
| **[generate-frontend-forms](generate-frontend-forms/)** | React forms / validation / auto-save / field composition |
| **[frontend-code-review](frontend-code-review/)** | 前端 `.tsx` / `.ts` / `.js` / CSS 變更的 PR review |
| **[frontend-testing](frontend-testing/)** | React / TS 前端 unit、component、RTL tests |
| **[react-dev](react-dev/)** | React 組件、hooks、事件型別、state、Server Components 開發 |
