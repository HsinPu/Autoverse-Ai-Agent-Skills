...
| **[java-code-style](java-code-style/)** | 撰寫或重構 Java 時的參考。提供程式碼風格（Google/Oracle 慣例、命名、格式、Javadoc、例外處理）與設計模式（SOLID、組合、DI、不可變性）。基準版本 Java 11+。適合：要**撰寫或重構 Java 程式碼**、討論風格與架構時使用。 |
